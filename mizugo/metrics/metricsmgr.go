...
//
// 如果想建立自訂度量, 執行 NewInt, NewFloat, NewString, NewMap, 就可以獲得自訂記錄器;
// 如果想建立執行度量, 執行 NewRuntime 就可以獲得執行記錄器
//
// 如果想查看自訂度量或度量數據, 可以從 https://github.com/divan/expvarmon 安裝expvarmon工具;
// 工具參數說明如下:
//   - ports="http://網址:埠號"
//   - vars="監控名稱:記錄名稱,..."
//   - i 間隔時間
//
// 如果想用expvarmon工具查看執行度量數據, 假設執行記錄器的名稱為'echo', 則改變var參數為
