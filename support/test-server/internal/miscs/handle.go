...
func HandleDatabase(mixedName, tableName string) (submit *depots.Submit, id msgs.ErrID, err error) {
	var database *depots.Mixed

	if database = mizugos.Depotmgr().GetMixed(mixedName); database == nil {
