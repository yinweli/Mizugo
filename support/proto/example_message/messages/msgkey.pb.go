...
func (x *KeyRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeyRes) ProtoMessage() {}

func (x *KeyRes) ProtoReflect() protoreflect.Message {
	mi := &file_msgkey_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeyRes.ProtoReflect.Descriptor instead.
func (*KeyRes) Descriptor() ([]byte, []int) {
	return file_msgkey_proto_rawDescGZIP(), []int{1}
}

func (x *KeyRes) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_msgkey_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x6d, 0x73, 0x67, 0x6b, 0x65, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x08,
	0x0a, 0x06, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x22, 0x1a, 0x0a, 0x06, 0x4b, 0x65, 0x79, 0x52,
	0x65, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x42, 0x14, 0x5a, 0x12, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
