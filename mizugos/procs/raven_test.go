...
func (this *SuiteRaven) TestRavenC() {
	...
	this.Equal(int32(1), RavenMessageID(builder))
	this.Equal(int32(0), RavenMessageID(nil))
	this.Equal(int32(0), RavenMessageID(testdata.Unknown))
	this.True(RavenIsMessageID(builder, 1))
	this.False(RavenIsMessageID(nil, 1))
	this.False(RavenIsMessageID(testdata.Unknown, 1))
	this.Equal(int32(1), RavenErrID(builder))
	this.Equal(int32(0), RavenErrID(nil))
	this.Equal(int32(0), RavenErrID(testdata.Unknown))
	this.True(RavenIsErrID(builder, 1))
	this.False(RavenIsErrID(nil, 1))
	this.False(RavenIsErrID(testdata.Unknown, 1))
	this.True(proto.Equal(message, RavenHeader(builder)))
	this.Nil(RavenHeader(nil))
	this.Nil(RavenHeader(testdata.Unknown))
	this.True(proto.Equal(message, RavenHeaderT[*msgs.RavenTest](builder)))
	this.Nil(RavenHeaderT[*msgs.RavenTest](nil))
	this.Nil(RavenHeaderT[*msgs.RavenTest](testdata.Unknown))
	this.Nil(RavenHeaderT[*msgs.ProtoTest](builder))
	this.True(proto.Equal(message, RavenRequest(builder)))
	this.Nil(RavenRequest(nil))
	this.Nil(RavenRequest(testdata.Unknown))
	this.True(proto.Equal(message, RavenRequestT[*msgs.RavenTest](builder)))
	this.Nil(RavenRequestT[*msgs.RavenTest](nil))
	this.Nil(RavenRequestT[*msgs.RavenTest](testdata.Unknown))
	this.Nil(RavenRequestT[*msgs.ProtoTest](builder))
	this.True(proto.Equal(message, RavenRespondAt(builder, 0)))
	this.Nil(RavenRespondAt(nil, 1))
	this.Nil(RavenRespondAt(testdata.Unknown, 1))
	this.Nil(RavenRespondAt(builder, -1))
	this.True(proto.Equal(message, RavenRespondAtT[*msgs.RavenTest](builder, 0)))
	this.Nil(RavenRespondAtT[*msgs.RavenTest](nil, 1))
	this.Nil(RavenRespondAtT[*msgs.RavenTest](testdata.Unknown, 1))
	this.Nil(RavenRespondAtT[*msgs.RavenTest](builder, -1))
	this.Nil(RavenRespondAtT[*msgs.ProtoTest](builder, 1))
	this.True(proto.Equal(message, RavenRespondFind(builder, message)))
	this.Nil(RavenRespondFind(nil, message))
	this.Nil(RavenRespondFind(builder, nil))
	this.Nil(RavenRespondFind(testdata.Unknown, message))
	this.Nil(RavenRespondFind(builder, &msgs.ProtoTest{}))
	this.True(proto.Equal(message, RavenRespondFindT[*msgs.RavenTest](builder)))
	this.Nil(RavenRespondFindT[*msgs.RavenTest](nil))
	this.Nil(RavenRespondFindT[*msgs.RavenTest](testdata.Unknown))
	this.Nil(RavenRespondFindT[*msgs.ProtoTest](builder))
}
