...
func (this *SuiteRaven) TestRavenC() {
	...
	assert.True(this.T(), proto.Equal(object, RavenRespondAt(output1, 0)))
	assert.Nil(this.T(), RavenRespondAt(output1, -1))
	assert.Nil(this.T(), RavenRespondAt(nil, 1))
	assert.True(this.T(), proto.Equal(object, RavenRespondFind(output1, &msgs.RavenTest{})))
	assert.Nil(this.T(), RavenRespondFind(output1, 0))
	assert.Nil(this.T(), RavenRespondFind(nil, &msgs.RavenTest{}))
