...
<root>
  ...
  ├── Editor
  │   ├── Undefined.MizugoClientUnity.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.MizugoClientUnity.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.MizugoClientUnity.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.MizugoClientUnity.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.MizugoClientUnity`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Mizugo-client-unity Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.MizugoClientUnity.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.MizugoClientUnity.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.MizugoClientUnity.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.MizugoClientUnity.Tests.asmdef`
...
Use the `Documentations~/Mizugo-client-unity.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
